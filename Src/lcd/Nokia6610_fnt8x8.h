...
{
{0x08,0x08,0x08,0x00,0x00,0x00,0x00,0x00},             // Р С™Р С•Р В»Р С‘РЎвЂЎР ВµРЎРѓРЎвЂљР Р†Р С•: РЎРѓРЎвЂљР С•Р В»Р В±РЎвЂ Р С•Р Р†, РЎРѓРЎвЂљРЎР‚Р С•Р С” Р С‘ Р В±Р В°Р в„–РЎвЂљ
...
{0x00,0x7C,0x7E,0x13,0x11,0x7F,0x7F,0x00},             //Р С’  [192]
{0x00,0x7F,0x7F,0x49,0x49,0x79,0x30,0x00},             //Р вЂ�  [193]
{0x00,0x7F,0x7F,0x49,0x49,0x7F,0x36,0x00},             //Р вЂ™  [194]
{0x00,0x7F,0x7F,0x01,0x01,0x01,0x01,0x00},             //Р вЂњ  [195]
{0xC0,0xFE,0x7F,0x41,0x7F,0xFE,0xC0,0x00},             //Р вЂќ  [196]
{0x00,0x7F,0x7F,0x49,0x49,0x49,0x41,0x00},             //Р вЂў  [197]
{0x63,0x77,0x1C,0x7F,0x7F,0x1C,0x77,0x63},             //Р вЂ“  [198]
{0x00,0x22,0x63,0x49,0x49,0x7F,0x36,0x00},             //Р вЂ”  [199]
{0x00,0x7F,0x7F,0x18,0x0C,0x7F,0x7F,0x00},             //Р пїЅ  [200]
{0x00,0x7E,0x7F,0x19,0x0D,0x7F,0x7E,0x00},             //Р в„ў  [201]
{0x00,0x7F,0x7F,0x1C,0x36,0x63,0x41,0x00},             //Р С™  [202]
{0x00,0x7C,0x7E,0x03,0x01,0x7F,0x7F,0x00},             //Р вЂє  [203]
{0x7F,0x7F,0x0E,0x1C,0x0E,0x7F,0x7F,0x00},             //Р Сљ  [204]
{0x00,0x7F,0x7F,0x08,0x08,0x7F,0x7F,0x00},             //Р Сњ  [205]
{0x00,0x3E,0x7F,0x41,0x41,0x7F,0x3E,0x00},             //Р С›  [206]
{0x00,0x7F,0x7F,0x01,0x01,0x7F,0x7F,0x00},             //Р Сџ  [207]
{0x00,0x7F,0x7F,0x11,0x11,0x1F,0x0E,0x00},             //Р В   [208]
{0x00,0x3E,0x7F,0x41,0x41,0x63,0x22,0x00},             //Р РЋ  [209]
{0x00,0x01,0x01,0x7F,0x7F,0x01,0x01,0x00},             //Р Сћ  [210]
{0x00,0x27,0x6F,0x48,0x48,0x7F,0x3F,0x00},             //Р Р€  [211]
{0x0E,0x1F,0x11,0x7F,0x7F,0x11,0x1F,0x0E},             //Р В¤  [212]
{0x00,0x63,0x77,0x1C,0x1C,0x77,0x63,0x00},             //Р Тђ  [213]
{0x00,0x7F,0x7F,0x40,0x40,0x7F,0xFF,0xC0},             //Р В¦  [214]
{0x00,0x07,0x0F,0x08,0x08,0x7F,0x7F,0x00},             //Р В§  [215]
{0x7F,0x7F,0x40,0x7F,0x7F,0x40,0x7F,0x7F},             //Р РЃ  [216]
{0x7F,0x7F,0x40,0x7F,0x7F,0x40,0xFF,0xFF},             //Р В©  [217]
{0x01,0x7F,0x7F,0x48,0x48,0x78,0x30,0x00},             //Р Р„  [218]
{0x7F,0x7F,0x48,0x78,0x30,0x7F,0x7F,0x00},             //Р В«  [219]
{0x00,0x7F,0x7F,0x48,0x48,0x78,0x30,0x00},             //Р В¬  [220]
{0x22,0x41,0x49,0x49,0x6B,0x3E,0x1C,0x00},             //Р В­  [221]
{0x7F,0x7F,0x08,0x3E,0x7F,0x41,0x7F,0x3E},             //Р В®  [222]
{0x00,0x4E,0x7F,0x31,0x11,0x7F,0x7F,0x00},             //Р Р‡  [223]
{0x20,0x74,0x54,0x54,0x3C,0x78,0x40,0x00},             //Р В°  [224]
{0x00,0x34,0x7E,0x4A,0x4A,0x7A,0x30,0x00},             //Р В±  [225]
{0x00,0x7C,0x7C,0x54,0x54,0x7C,0x28,0x00},             //Р Р†  [226]
{0x00,0x7C,0x7C,0x04,0x04,0x04,0x04,0x00},             //Р С–  [227]
{0xC0,0xF8,0x7C,0x44,0x7C,0xFC,0xC0,0x00},             //Р Т‘  [228]
{0x00,0x38,0x7C,0x54,0x54,0x5C,0x18,0x00},             //Р Вµ  [229]
{0x44,0x6C,0x38,0x7C,0x7C,0x38,0x6C,0x44},             //Р В¶  [230]
{0x00,0x28,0x6C,0x44,0x54,0x7C,0x28,0x00},             //Р В·  [231]
{0x00,0x7C,0x7C,0x30,0x18,0x7C,0x7C,0x00},             //Р С‘  [232]
{0x00,0x7C,0x7C,0x32,0x1A,0x7C,0x7C,0x00},             //Р в„–  [233]
{0x00,0x7C,0x7C,0x10,0x38,0x6C,0x44,0x00},             //Р С”  [234]
{0x00,0x70,0x78,0x0C,0x04,0x7C,0x7C,0x00},             //Р В»  [235]
{0x7C,0x7C,0x18,0x38,0x18,0x7C,0x7C,0x00},             //Р С�  [236]
{0x00,0x7C,0x7C,0x10,0x10,0x7C,0x7C,0x00},             //Р Р…  [237]
{0x00,0x38,0x7C,0x44,0x44,0x7C,0x38,0x00},             //Р С•  [238]
{0x00,0x7C,0x7C,0x04,0x04,0x7C,0x7C,0x00},             //Р С—  [239]
{0x00,0x7C,0x7C,0x24,0x24,0x3C,0x18,0x00},             //РЎР‚  [240]
{0x00,0x38,0x7C,0x44,0x44,0x6C,0x28,0x00},             //РЎРѓ  [241]
{0x00,0x04,0x04,0x7C,0x7C,0x04,0x04,0x00},             //РЎвЂљ  [242]
{0x00,0x0C,0x5C,0x50,0x50,0x7C,0x3C,0x00},             //РЎС“  [243]
{0x18,0x3C,0x24,0x7C,0x7C,0x24,0x3C,0x18},             //РЎвЂћ  [244]
{0x00,0x44,0x6C,0x38,0x38,0x6C,0x44,0x00},             //РЎвЂ¦  [245]
{0x00,0x7C,0x7C,0x40,0x40,0x7C,0xFC,0xC0},             //РЎвЂ   [246]
{0x00,0x0C,0x1C,0x10,0x10,0x7C,0x7C,0x00},             //РЎвЂЎ  [247]
{0x7C,0x7C,0x40,0x7C,0x7C,0x40,0x7C,0x7C},             //РЎв‚¬  [248]
{0x7C,0x7C,0x40,0x7C,0x7C,0x40,0xFC,0xFC},             //РЎвЂ°  [249]
{0x04,0x7C,0x7C,0x50,0x50,0x70,0x20,0x00},             //РЎР‰  [250]
{0x7C,0x7C,0x50,0x70,0x20,0x7C,0x7C,0x00},             //РЎвЂ№  [251]
{0x00,0x7C,0x7C,0x50,0x50,0x70,0x20,0x00},             //РЎРЉ  [252]
{0x00,0x44,0x54,0x54,0x54,0x7C,0x38,0x00},             //РЎРЊ  [253]
{0x7C,0x7C,0x10,0x38,0x7C,0x44,0x7C,0x38},             //РЎР‹  [254]
{0x00,0x48,0x7C,0x34,0x14,0x7C,0x7C,0x00}              //РЎРЏ  [255]
